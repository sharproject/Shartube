...
export type ComicInfoFragment = { __typename?: 'Comic', _id: string, name: string, description?: string | null, background?: string | null, CreatedByID: string } & { ' $fragmentName'?: 'ComicInfoFragment' };

export type UserInfoFragment = { __typename?: 'User', _id: string, email: string, name: string, updatedAt: any, createdAt: any, password: string, profile?: { __typename?: 'Profile', _id: string, comics: Array<{ __typename?: 'Comic', _id: string, name: string, description?: string | null, thumbnail?: string | null } | null>, ShortComics: Array<{ __typename?: 'ShortComic', _id: string, name: string, description?: string | null, thumbnail?: string | null } | null> } | null } & { ' $fragmentName'?: 'UserInfoFragment' };
...
export type TopViewComicsQuery = { __typename?: 'Query', TopViewComic: Array<(
    { __typename?: 'Comic' }
    & { ' $fragmentRefs'?: { 'ComicInfoFragment': ComicInfoFragment } }
  ) | null> };
