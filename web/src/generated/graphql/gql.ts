...
const documents = {
    ...
    "query EditPageShortComicByID($id: String!) {\n  ShortComicByID(id: $id) {\n    ...EditPageShortComicInfo\n  }\n}": types.EditPageShortComicByIdDocument,
    "query Me {\n  Me {\n    ...UserInfo\n  }\n}": types.MeDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query EditPageShortComicByID($id: String!) {\n  ShortComicByID(id: $id) {\n    ...EditPageShortComicInfo\n  }\n}"): (typeof documents)["query EditPageShortComicByID($id: String!) {\n  ShortComicByID(id: $id) {\n    ...EditPageShortComicInfo\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
