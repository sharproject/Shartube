...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "ShortComicChap":
			resolverName, err := entityResolverNameForShortComicChap(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "ShortComicChap": %w`, err)
			}
			switch resolverName {
			...
			case "findShortComicChapByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findShortComicChapByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindShortComicChapByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "ShortComicChap": %w`, err)
				}
...
func entityResolverNameForShortComicChap(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findShortComicChapByID", nil
	}
	return "", fmt.Errorf("%w for ShortComicChap", ErrTypeNotFound)
}
